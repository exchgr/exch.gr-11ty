...
latest_tag_for_repo() {
  local tag
  # $1 comes from local workflow `uses:` lines and is interpolated into a gh
  # api path and an https URL; a strict slug check keeps arbitrary text from
  # ever reaching either network call. Non-slugs fail fast so callers take
  # their existing soft path (warn + keep the old pin).
